...
public class AlgoritmoGenetico {
  ...
  public void executaAlgoritmoGenetico() {
    ...
    for (int i = 0; i < quantidadeDeGeracoes; i++) {
      ...
      // System.out.println("ELITISMO " + this.elitismo.toString() + "Posicao" +
      // this.elitismo.getIndexNPonto());
  ...
  public Individuo[] selecao(Populacao populacao) {
    ...
    Individuo[] pai = { populacao.getIndividuos()[gerador.nextInt(tamPopulacao)],
        populacao.getIndividuos()[gerador.nextInt(tamPopulacao)] }; // seleciona dois Individuo aleatórios para o pai
    Individuo[] mae = { populacao.getIndividuos()[gerador.nextInt(tamPopulacao)],
        populacao.getIndividuos()[gerador.nextInt(tamPopulacao)] }; // seleciona dois Individuo aleatórios para o mae
  ...
  public double Aptidao(Individuo Individuo) {
    ...
    // aptidao = (IndividuoPercorrido.getIndexNPonto()+1)+ ((50 +
    // IndividuoPercorrido.getComidasColetadas()) == 0 ? 1 : (50 +
    // IndividuoPercorrido.getComidasColetadas()));
